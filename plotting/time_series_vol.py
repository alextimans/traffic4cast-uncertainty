"""
This script generates the sample time series of traffic activity for each city.
"""
...
m = 100 # MODIFY HERE (morning time)
e = 210 # MODIFY HERE (evening time)
